...
from utils.assist_model_network import swish, get_affine_params
...
class DynModel(nn.Module):
    ...
    def forward(self, inputs, ret_logvar=False):
        ...
        inputs = swish(inputs)      # Google Brain于2017年提出的activation function: x * sigmoid(x)
...
# TODO: 因为agent没有策略网络pi，在做evaluate的时候需要考虑如何输出最优动作
def nn_constructor(num_models, input_dim, output_dim, load_models=None):
